//! Runtime proof-receipt viewer.
//!
//! This is a non-authoritative presentation of recorded fields. It does not
//! establish inclusion, finality, seal consumption, or transfer acceptance.
            ...
            div { class: "space-y-4",
                ...
                div { class: "p-3 bg-blue-900/20 border border-blue-500/30 rounded-lg",
                    p { class: "text-sm text-blue-300",
                        "This is a recorded anchor reference. Transfer acceptance requires a runtime verification receipt with live inclusion and finality evidence."
                    }
                }
            }
        }
            ...
            div { class: "space-y-4",
                ...
                div { class: "p-3 bg-purple-900/20 border border-purple-500/30 rounded-lg",
                    p { class: "text-sm text-purple-300",
                        "The displayed seal reference is not proof of consumption. The runtime establishes single-use and replay protection before any transfer advances."
                    }
                }
            }
        }
                ...
                div { class: "space-y-4",
                    ...
                    div { class: "p-3 bg-amber-900/20 border border-amber-500/30 rounded-lg",
                        p { class: "text-sm text-amber-300",
                            "Displayed inclusion fields are informational. The runtime independently verifies inclusion before transfer acceptance."
                        }
                    }
                }
            } else {
    ...
    rsx! {
        div { class: "{card_class()} p-6",
            ...
            div { class: "space-y-4",
                ...
                div { class: "p-3 bg-amber-900/20 border border-amber-500/30 rounded-lg",
                    p { class: "text-sm text-amber-300",
                        "Displayed finality status is not acceptance evidence. The runtime establishes finality from an observed chain tip."
                    }
                }
            }
        }
        ...
        div { class: "{card_class()} p-6",
            ...
            div { class: "space-y-4",
                p { class: "text-sm text-gray-400",
                    "Direct verification is unavailable in the wallet. The runtime must verify trusted signer binding, inclusion, finality, and replay protection before a proof can affect a transfer."
                }

                div { class: "mt-4 p-4 bg-amber-900/20 border border-amber-500/30 rounded-lg",
                    h3 { class: "text-sm font-semibold text-amber-300 mb-2", "Runtime receipt required" }
                    p { class: "text-sm text-gray-300",
                        "This page is an informational projection, not a cryptographic acceptance result."
                    }
                }
            }
        }
