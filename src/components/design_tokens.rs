...
:root {
    /* Layout/input policy.  The matching media query lives in style.css,
       where CSS can evaluate it without a platform-specific Rust branch. */
    --layout-nav-breakpoint: 48rem;
